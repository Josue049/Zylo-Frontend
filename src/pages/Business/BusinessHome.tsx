...
export default function BusinessDashboard() {
  ...
  useEffect(() => {
    apiFetch("/businesses/me/bookings/aceptado")
      .then((data) => {
      ...
      <main className='pt-24 pb-36 px-6 max-w-7xl mx-auto'>
        ...
        <section className='grid grid-cols-1 md:grid-cols-4 gap-6 mb-12'>
          ...
          <div className='bg-primary p-8 rounded-xl text-[#ffefeb] flex flex-col justify-between shadow-xl shadow-primary/20'>
            <div>
              <span className='font-label font-semibold uppercase tracking-wider opacity-80 text-xs'>
                Disponibilidad
              </span>
              <div className='font-headline text-xl font-bold mt-2'>
                Actualmente Activo
              </div>
            </div>
            <div className='mt-6 flex items-center justify-between bg-white/20 p-4 rounded-full'>
              ...
              >
                <div
                  className={`w-4 h-4 bg-primary rounded-full shadow-md transition-all duration-300 ${blocked ? "ml-auto" : ""}`}
                />
              </button>
            </div>
          </div>
            ...
            <div className='bg-[#2f2f2e] p-8 rounded-xl text-[#f9f6f5] relative overflow-hidden'>
              <div className='relative z-10'>
                <h3 className='font-headline text-xl font-bold mb-2'>
                  Actualiza a Zylo Pro
                </h3>
                <p className='text-[#d6d4d3] text-sm mb-6'>
                  Desbloquea análisis avanzados y posicionamiento prioritario en
