...
export default function MessagesPage() {
  ...
  useEffect(() => {
    ...
    void (async () => {
      await markConversationAsRead(activeConvId, session.email, "user");
  ...
  return (
    <div className="bg-[#f9f6f5] h-screen font-body flex flex-col overflow-hidden">
      ...
      <div className="flex-1 max-w-5xl w-full mx-auto px-4 py-6 flex flex-col min-h-0 overflow-hidden">
        {/* Title */}
